...
.pd .pd-seen { background: #faf7f2; padding: 2.25rem 1.25rem; }
.pd .pd-seen-label { text-align: center; font-size: 0.78em !important; text-transform: uppercase; letter-spacing: 0.18em; color: #888; font-weight: 700; margin: 0 auto 1.4rem; }
.pd .pd-seen-logos { max-width: 1000px; margin: 0 auto; display: grid; grid-template-columns: repeat(5, 1fr); gap: 1.5rem; align-items: center; }
@media (max-width: 760px) { .pd .pd-seen-logos { grid-template-columns: repeat(3, 1fr); gap: 1.25rem 1rem; } }
@media (max-width: 460px) { .pd .pd-seen-logos { grid-template-columns: repeat(2, 1fr); } }
.pd .pd-seen-logo { display: flex; align-items: center; justify-content: center; padding: 0.4rem; min-height: 42px; }
.pd .pd-seen-logo img { max-height: 42px; max-width: 100%; width: auto; height: auto; display: block; filter: grayscale(100%); opacity: 0.65; transition: opacity 0.2s; }
.pd .pd-seen-logo img:hover { opacity: 0.95; }
...
<section class="pd-seen">
  <div class="pd-seen-label">As Seen On</div>
  <div class="pd-seen-logos">
    <div class="pd-seen-logo"><img src="[urban prepper]" alt="Urban Prepper"></div>
    <div class="pd-seen-logo"><img src="[gear junkie]" alt="Gear Junkie"></div>
    <div class="pd-seen-logo"><img src="[city prepping]" alt="City Prepping"></div>
    <div class="pd-seen-logo"><img src="[recoil off-grid]" alt="Recoil Off-Grid"></div>
    <div class="pd-seen-logo"><img src="[casual preppers]" alt="Casual Preppers"></div>
  </div>
</section>
