# Prepper Disk Premium — CRO Test Version (v2, with VSL video)
...
**Save as:** `sections/prepper-disk-cro.liquid` in your Dawn theme.
...
<section class="pd-block" id="pd-reviews">
<div class="pd-container">
