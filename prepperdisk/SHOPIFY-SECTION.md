...
.pd .pd-trust-row { display: flex; flex-direction: column; align-items: center; padding: 26px 32px; gap: 18px; text-align: center; }
.pd .pd-trust-row.pd-trusted { background: #e8f2fa; border-bottom: 1px solid #c9dcec; }
.pd .pd-trust-row.pd-rating-row { background: #d7e7f4; }
.pd .pd-trust-label { font-size: 11px !important; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; color: #5a8db3; line-height: 1.2; }
.pd .pd-trust-label span { display: block; font-family: 'Bebas Neue', sans-serif; font-size: 22px !important; letter-spacing: 0.06em; color: #1a3a5c; margin-bottom: 1px; font-weight: 400; }
.pd .pd-trust-logos { display: flex; align-items: center; justify-content: center; gap: 32px; flex-wrap: wrap; }
.pd .pd-trust-logos img { display: block; opacity: 0.55; transition: opacity 0.2s; max-height: 38px; width: auto; }
.pd .pd-trust-logos img:hover { opacity: 0.85; }
.pd .pd-trust-logo-ph { font-size: 10px !important; font-weight: 700; letter-spacing: 0.05em; color: #5a8db3; text-transform: uppercase; padding: 8px 14px; border: 1px dashed #5a8db3; border-radius: 4px; opacity: 0.75; background: transparent; min-height: 0; }
.pd .pd-trust-rating { display: inline-flex; align-items: center; gap: 0.65rem; }
.pd .pd-trust-rating-num { font-family: 'Bebas Neue', sans-serif; font-size: 30px !important; color: #1a3a5c; line-height: 1; letter-spacing: 0.02em; }
.pd .pd-trust-rating-stars { color: #f5a623; font-size: 22px !important; letter-spacing: 0.1em; line-height: 1; }
@media (max-width: 600px) {
  .pd .pd-trust-row { padding: 22px 20px; gap: 14px; }
  .pd .pd-trust-logos { gap: 22px; }
  .pd .pd-trust-logos img { max-height: 32px; }
  .pd .pd-trust-rating-num { font-size: 26px !important; }
  .pd .pd-trust-rating-stars { font-size: 18px !important; }
}
...
<section class="pd-hero">
  <div class="pd-container">
    ...
    <div class="pd-ph pd-shot">[Hero Shot]</div>
    <ul class="pd-bullets">
    ...
    <div class="pd-trust">🔒 Secure checkout   •   🚚 Ships from USA   •   ✅ 60-day returns   •   🛡️ 1-year warranty</div>
  </div>
</section>

<section class="pd-cred">
  <div class="pd-trust-bar">

    <div class="pd-trust-row pd-trusted">
      <div class="pd-trust-label">
        <span>Prepper Disk</span>
        Trusted by
      </div>
      <div class="pd-trust-logos">
        <div class="pd-trust-logo-ph">[Casual Prepper]</div>
        <div class="pd-trust-logo-ph">[Urban Prepper]</div>
        <div class="pd-trust-logo-ph">[Alaska Prepper]</div>
        <div class="pd-trust-logo-ph">[City Prepper]</div>
      </div>
    </div>

    <div class="pd-trust-row pd-rating-row">
      <div class="pd-trust-label">
        <span>Stashed in over 7,000 households</span>
        Average rating
      </div>
      <div class="pd-trust-rating">
        <span class="pd-trust-rating-num">4.8</span>
        <span class="pd-trust-rating-stars">★★★★★</span>
      </div>
    </div>
  ...
  <div class="pd-container">
    ...
    <div class="pd-pgrid">
      <div class="pd-pcard">
        ...
        <div class="pd-pbody">
          <div class="pd-ph pd-pcard-img">[Storm Damage]</div>
      ...
      <div class="pd-pcard">
        ...
        <div class="pd-pbody">
          <div class="pd-ph pd-pcard-img">[Censored Screen]</div>
      ...
      <div class="pd-pcard">
        ...
        <div class="pd-pbody">
          <div class="pd-ph pd-pcard-img">[Cable Severed]</div>
...
Most are not worried anymore about the “if”, but of the “when”.</p>
      ...
      <div class="pd-pcard">
        ...
        <div class="pd-pbody">
          <div class="pd-ph pd-pcard-img">[Off-Grid Cabin]</div>
...
<section class="pd-block pd-alt">
  <div class="pd-container">
    ...
    <div class="pd-ph pd-sol-img">[Setup Demo]</div>
...
<section class="pd-block pd-alt">
  <div class="pd-container">
    ...
    <div class="pd-scenes">
      <div class="pd-scene">
        <div class="pd-scene-img"><div class="pd-ph">[First Aid]</div></div>
      ...
      <div class="pd-scene pd-flip">
        <div class="pd-scene-img"><div class="pd-ph">[Bug Out]</div></div>
        <div class="pd-scene-content">
          <button class="pd-scene-sum" type="button">
      ...
      <div class="pd-scene">
        <div class="pd-scene-img"><div class="pd-ph">[Car Repair]</div></div>
        <div class="pd-scene-content">
          <button class="pd-scene-sum" type="button">
      ...
      <div class="pd-scene pd-flip">
        <div class="pd-scene-img"><div class="pd-ph">[Kids Learning]</div></div>
        <div class="pd-scene-content">
          <button class="pd-scene-sum" type="button">
      ...
      <div class="pd-scene">
        <div class="pd-scene-img"><div class="pd-ph">[Offline Map]</div></div>
        <div class="pd-scene-content">
          <button class="pd-scene-sum" type="button">
      ...
      <div class="pd-scene pd-flip">
        <div class="pd-scene-img"><div class="pd-ph">[Off-Grid Read]</div></div>
        <div class="pd-scene-content">
          <button class="pd-scene-sum" type="button">
...
<section class="pd-block pd-alt">
  <div class="pd-container">
    ...
    <div class="pd-tests">
      <div class="pd-test">
        <div class="pd-test-img"><div class="pd-ph">[Douglas Photo]</div></div>
      ...
      <div class="pd-test">
        <div class="pd-test-img"><div class="pd-ph">[Micaela Photo]</div></div>
        <div class="pd-test-stars">★★★★★</div>
        <div class="pd-test-body">
      ...
      <div class="pd-test">
        <div class="pd-test-img"><div class="pd-ph">[Garrett Photo]</div></div>
        <div class="pd-test-stars">★★★★★</div>
        <div class="pd-test-body">
  ...
  <div class="pd-container">
    ...
    <div class="pd-mono">
      <div class="pd-mono-img">
        <div class="pd-ph">[Product Shot]</div>
      </div>
...
<section class="pd-guar">
  <div class="pd-container">
    ...
    <div class="pd-seal-wrap">
      <div class="pd-ph" style="width: 180px; height: 180px; border-radius: 12px;">[Guarantee Badge]</div>
    </div>
...
<section class="pd-block pd-alt" id="pd-about">
  <div class="pd-container">
    ...
    <div class="pd-adam-profile">[Adam Profile]</div>
    <div class="pd-about">
      <div class="pd-ph">[Adam Workshop]</div>
      <div class="pd-about-body">
        <p>Hi, Adam here! That's me in the garage that started it all. [EXPAND MOBILE]]</p>
        <div class="pd-about-more">
          ...
          <p>… why don't we have something like that ready for when things go sideways closer to home?</p>
          ...
          <p>We worked closely with survival experts and seasoned preppers to make sure everything on the disk was genuinely useful in the field.</p>
          <p>The response since launch has honestly blown us away. Families, schools, and survival experts - they all praised The Prepper Disk.</p>
          <p>My wife, daughter, and I still pack and ship every unit ourselves, right from home in Massachusetts. </p>
          <p>And the fact that something that started on our workbench is now in 7,000+ homes around the world… that's something we're genuinely proud of. </p>
        </div>
  ...
  <div class="pd-container">
    ...
    <div class="pd-opts">
      ...
      <div class="pd-opt pd-best">
        ...
        <p>You hit our secure checkout, which notifies us.</p>
        <p>We then go to work. A family member or I will prepare your package in person.</p>
