...
<section class="pd-hero">
  <div class="pd-container">
    ...
    <div class="pd-ph pd-shot"><img src="[hero shot]" alt="Prepper Disk hero shot"></div>
    <ul class="pd-bullets">
  ...
  <div class="pd-container">
    ...
    <div class="pd-pgrid">
      <div class="pd-pcard">
        ...
        <div class="pd-pbody">
          <div class="pd-ph pd-pcard-img"><img src="[storm damage]" alt="Storm damage"></div>
      ...
      <div class="pd-pcard">
        ...
        <div class="pd-pbody">
          <div class="pd-ph pd-pcard-img"><img src="[censored screen]" alt="Censored website"></div>
      ...
      <div class="pd-pcard">
        ...
        <div class="pd-pbody">
          <div class="pd-ph pd-pcard-img"><img src="[cable severed]" alt="Severed undersea cable"></div>
...
Most are not worried anymore about the “if”, but of the “when”.</p>
      ...
      <div class="pd-pcard">
        ...
        <div class="pd-pbody">
          <div class="pd-ph pd-pcard-img"><img src="[off-grid cabin]" alt="Off-grid cabin"></div>
...
<section class="pd-block pd-alt">
  <div class="pd-container">
    ...
    <div class="pd-ph pd-sol-img"><img src="[setup demo]" alt="Prepper Disk setup demo"></div>
...
<section class="pd-block pd-alt">
  <div class="pd-container">
    ...
    <div class="pd-scenes">
      <div class="pd-scene">
        <div class="pd-scene-img"><div class="pd-ph"><img src="[first aid]" alt="Medical emergency lookup"></div></div>
      ...
      <div class="pd-scene pd-flip">
        <div class="pd-scene-img"><div class="pd-ph"><img src="[bug out]" alt="Bug out shelter"></div></div>
        <div class="pd-scene-content">
          <button class="pd-scene-sum" type="button">
      ...
      <div class="pd-scene">
        <div class="pd-scene-img"><div class="pd-ph"><img src="[car repair]" alt="Car repair walkthrough"></div></div>
        <div class="pd-scene-content">
          <button class="pd-scene-sum" type="button">
      ...
      <div class="pd-scene pd-flip">
        <div class="pd-scene-img"><div class="pd-ph"><img src="[kids learning]" alt="Kids learning offline"></div></div>
        <div class="pd-scene-content">
          <button class="pd-scene-sum" type="button">
      ...
      <div class="pd-scene">
        <div class="pd-scene-img"><div class="pd-ph"><img src="[offline map]" alt="Offline city map"></div></div>
        <div class="pd-scene-content">
          <button class="pd-scene-sum" type="button">
      ...
      <div class="pd-scene pd-flip">
        <div class="pd-scene-img"><div class="pd-ph"><img src="[off-grid read]" alt="Reading off-grid"></div></div>
        <div class="pd-scene-content">
          <button class="pd-scene-sum" type="button">
...
<section class="pd-block pd-alt">
  <div class="pd-container">
    ...
    <div class="pd-tests">
      <div class="pd-test">
        <div class="pd-test-img"><div class="pd-ph"><img src="[douglas photo]" alt="Douglas G."></div></div>
      ...
      <div class="pd-test">
        <div class="pd-test-img"><div class="pd-ph"><img src="[micaela photo]" alt="Micaela B."></div></div>
        <div class="pd-test-stars">★★★★★</div>
        <div class="pd-test-body">
      ...
      <div class="pd-test">
        <div class="pd-test-img"><div class="pd-ph"><img src="[garrett photo]" alt="Garrett D."></div></div>
        <div class="pd-test-stars">★★★★★</div>
        <div class="pd-test-body">
  ...
  <div class="pd-container">
    ...
    <div class="pd-mono">
      <div class="pd-mono-img">
        <div class="pd-ph"><img src="[product shot]" alt="Prepper Disk Premium"></div>
      </div>
...
<section class="pd-guar">
  <div class="pd-container">
    ...
    <div class="pd-seal-wrap">
      <div class="pd-ph" style="width: 180px; height: 180px; border-radius: 12px;"><img src="[guarantee badge]" alt="60-day money-back guarantee"></div>
    </div>
...
<section class="pd-block pd-alt" id="pd-about">
  <div class="pd-container">
    ...
    <div class="pd-adam-profile"><img src="[adam profile]" alt="Adam"></div>
    <div class="pd-about">
      <div class="pd-ph"><img src="[adam workshop]" alt="Adam in workshop with family"></div>
  ...
  <div class="pd-container">
    ...
    <div class="pd-opts">
      ...
      <div class="pd-opt pd-best">
        ...
        <div class="pd-ph"><img src="[jackson packing]" alt="Jackson packing a Prepper Disk"></div>
